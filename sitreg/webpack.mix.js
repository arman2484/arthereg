  ...
  plugins: [
    new IgnorePlugin({
      checkResource(resource, context) {
        return [
          path.join(__dirname, 'resources/public/assets/vendor/libs/@form-validation')
...
function mixAssetsDir(query, cb) {
  (glob.sync('resources/public/assets/' + query) || []).forEach(f => {
    f = f.replace(/[\\\/]+/g, '/');
    cb(f, f.replace('resources/public/assets/', 'public/public/assets/'));
  });
}
...
mix.copy('node_modules/boxicons/fonts/*', 'public/public/assets/vendor/fonts/boxicons');
mix.copy('node_modules/flag-icons/flags/1x1/*', 'public/public/assets/vendor/fonts/flags/1x1');
mix.copy('node_modules/flag-icons/flags/4x3/*', 'public/public/assets/vendor/fonts/flags/4x3');
mix.copy('node_modules/@fortawesome/fontawesome-free/webfonts/*', 'public/public/assets/vendor/fonts/fontawesome');
mix.copy('node_modules/katex/dist/fonts/*', 'public/public/assets/vendor/libs/quill/fonts');
