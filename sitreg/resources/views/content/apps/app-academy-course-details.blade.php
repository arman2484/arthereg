...
@section('title', 'Academy - Courses Details - Apps')
                ...
                <div class="card academy-content shadow-none border">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="me-5">
                                <p class="text-nowrap"><i class='bx bx-check-double bx-sm me-2'></i>Skill level: All Levels
                                </p>
                        ...
                        <div class="d-flex justify-content-start align-items-center user-name">
                            <div class="avatar-wrapper">
                                <div class="avatar avatar-sm me-2"><img src="{{ asset('assets/img/avatars/11.png') }}"
