            ...
            <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
                <ul class="nav nav-align-left nav-pills flex-column">
                    <li class="nav-item mb-1">
                        <a class="nav-link active" href="{{ url('/app/ecommerce/payment/cod') }}">
                    ...
                    <li class="nav-item mb-1">
                        <a class="nav-link " href="{{ url('/app/ecommerce/payment/cheque') }}">
                            <i class="bx bxs-credit-card me-2"></i>
                            <span class="align-middle">Cheque</span>
                            @if (App\Models\Settings::where('id', 5)->first()->status == 1)
                                <i title="Active" class="fa fa-circle text-success ms-auto" aria-hidden="true"></i>
                            @else
                                <i title="Active" class="fa fa-circle text-danger ms-auto" aria-hidden="true"></i>
                            @endif
                ...
                <div class="tab-pane fade show active" id="store_details" role="tabpanel">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title m-0">Cash On Delivery</h5>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3 g-3">
                                <form action="{{ url('app/ecommerce/setting/stripe') }}" method="POST" class="pt-0">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-category-title"><strong>payment
                                                type</strong></label>
                                        <input type="text" class="form-control" id="ecommerce-category-title"
                                            placeholder="Enter your payment type" name="stripe_key"
