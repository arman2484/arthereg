...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light"></span> Add Country
    </h4>

    <form action="{{ url('app/ecommerce/country/add') }}" method="POST" class="pt-0"enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="card-body">
                            <div class="mb-3 col ecommerce-select2-dropdown">
                                <div class="mb-3 ecommerce-select2-dropdown">
                                    <label class="form-label" for="ecommerce-country">Country <span class="text-danger">
                                            *</span></label>
                                ...
                                <div class="mb-3 ecommerce-select2-dropdown">
                                    <label class="form-label" for="ecommerce-country">Code<span class="text-danger">
                                            *</span></label>
                                    <select id="code_id" name="code_id" class="select2 form-select"
                                        data-placeholder="Select Country">
                                        <option value="">Select Country Code</option>
                                        @foreach ($data as $value)
                                            <option value="{{ $value->id }}">{{ $value->iso3 }}</option>
                                        @endforeach
                                    </select>
