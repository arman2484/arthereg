...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Sitreg /</span><span> View Store</span>
    </h4>
        ...
        <div class="app-ecommerce">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                <div class="d-flex flex-column justify-content-center">
                    <h4 class="mb-1 mt-3">View your Store</h4>
                    <p class="text-muted">Discover the range of available store</p>
                </div>
                <div class="d-flex align-content-center flex-wrap gap-3">
                    <a href="/app/ecommerce/store/list" class="btn btn-secondary">Back</a>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="store_name" placeholder="Enter Store Name"
                                    name="store_name" aria-label="Store title" value="{{ $data->store_name }}" disabled>
                            ...
                            <div>
                                ...
                                <textarea name="store_description" class="form-control" id="store_description" placeholder="Enter Store Description"
                                    cols="30" rows="5" disabled>{{ $data->store_description }}</textarea>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <input type="file" name="store_images[]" class="form-control" multiple id="imageUpload"
                                accept="image/*" style="margin-top: 15px;" value="{{ $data->store_name }}" disabled>
                                        ...
                                        @foreach ($data->storeImages as $value)
                                            <div class="col-md-2" id="image-preview_{{ $value->id }}">
                                                <img src="{{ asset('assets/images/store_images/' . $value->store_images) }}"
                                                    style="width: 150px; height:150px;" class="me-4 border" disabled>
                                            </div>
                                        @endforeach
                                    </div>
                                @endif
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <input type="file" name="store_logo" class="form-control form-control-lg"
                                    id="exampleInputFile" disabled>
                                @if ($data->store_logo)
                                    <div class="mt-2">
                                        <img src="{{ asset('assets/images/store_logo/' . $data->store_logo) }}"
                                            alt="Store Logo" style="max-width: 100px; height:100px;" disabled>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="padding-bottom: 20px;">
                                    ...
                                    <select id="vendor_id" name="vendor_id" class="select2 form-select"
                                        data-placeholder="Select Vendor" disabled>
                                ...
                                <div class="col-md-3" style="padding-bottom: 20px;">
                                    ...
                                    <select id="open_time" name="open_time" class="select2 form-select"
                                        data-placeholder="Open Time" disabled>
                                ...
                                <div class="col-md-3" style="padding-bottom: 20px;">
                                    ...
                                    <select id="close_time" name="close_time" class="select2 form-select"
                                        data-placeholder="Close Time" disabled>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div style="flex: 1; margin-right: 10px;">
                                    ...
                                    <input type="number" class="form-control" id="min_time"
                                        ...
                                        aria-label="Enter Min delivery time" value="{{ $data->min_time }}" disabled>
                                ...
                                <div style="flex: 1; margin-right: 10px;">
                                    ...
                                    <input type="number" class="form-control" id="max_time"
                                        ...
                                        aria-label="Enter Max Delivery Time" value="{{ $data->max_time }}" disabled>
                            ...
                            <div class="card-body">
                                <div class="custom-file">
                                    <textarea class="form-control" name="address" rows="2" placeholder="Enter Your Store Location" id="pac-input"
                                        style="margin-bottom: 20px;" disabled>{{ $data->store_address ?? '' }}</textarea>
                                    <div class="text-lg-center alert-danger" id="info"></div>
                                    <div id="map" data-lat="{{ $data->lat }}" data-lng="{{ $data->lon }}"
                                        style="height: 400px; width: 100%;" disabled></div>
                                </div>
                            </div>
                        </div>
                    </div>
