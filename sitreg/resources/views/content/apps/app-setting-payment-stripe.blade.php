...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Payment /</span> Payment
    </h4>
                ...
                <ul class="nav nav-align-left nav-pills flex-column">
                    <li class="nav-item mb-1">
                        <div class="d-flex justify-content-between align-items-center">
                            <a class="nav-link active" href="{{ url('/app/ecommerce/setting/stripe') }}">
                    ...
                    <li class="nav-item mb-1">
                        <a class="nav-link" href="{{ url('/app/ecommerce/settings/flutterwave') }}">
                            <i class="bx bxs-credit-card me-2"></i>
                            <span class="align-middle">Flutterwave Payment</span>
                            @if (App\Models\Settings::where('id', 3)->first()->status == 1)
                                <i title="Active" class="fa fa-circle text-success ms-auto" aria-hidden="true"></i>
                            @else
                                <i title="Active" class="fa fa-circle text-danger ms-auto" aria-hidden="true"></i>
                            @endif
                        ...
                        <div class="card-body">
                            <div class="row mb-3 g-3">
                                <form action="{{ url('app/ecommerce/setting/stripe') }}" method="POST" class="pt-0">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-category-title"><strong>Payment Stripe
                                                Key</strong></label>
                                        ...
                                        <small class="text-muted"><i class="fa fa-question-circle"></i>
                                            Enter your STRIPE CLIENT ID
                                        </small>
                                    </div>
                                    <br>
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-category-title"><strong>Stripe
                                                Secret</strong></label>
                                        <input type="password" class="form-control" id="ecommerce-category-title"
