            ...
            <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
                <ul class="nav nav-align-left nav-pills flex-column">
                    <li class="nav-item mb-1">
                        <a class="nav-link " href="{{ url('/app/ecommerce/payment/cod') }}">
                            <i class="bx bxs-credit-card me-2"></i>
                            <span class="align-middle">Cash On Delivery</span>
                            @if (App\Models\Settings::where('id', 4)->first()->status == 1)
                    ...
                    <li class="nav-item mb-1">
                        <a class="nav-link active" href="{{ url('/app/ecommerce/payment/cheque') }}">
                            <i class="bx bxs-credit-card me-2"></i>
                ...
                <div class="tab-pane fade show active" id="store_details" role="tabpanel">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title m-0">Cheque</h5>
                        </div>
                        <div class="card-body">
