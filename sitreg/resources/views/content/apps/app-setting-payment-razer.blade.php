        ...
        <div class="col-12 col-lg-4">
            <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
                <ul class="nav nav-align-left nav-pills flex-column">
                    ...
                    <li class="nav-item mb-1">
                        <div class="d-flex justify-content-between align-items-center">
                            <a class="nav-link active" href="{{ url('/app/ecommerce/settings/razer') }}">
                                <i class="bx bxs-credit-card me-2"></i>
                ...
                <div class="tab-pane fade show active" id="store_details" role="tabpanel">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title m-0">Razer Payment</h5>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3 g-3">
                                <form action="{{ url('app/ecommerce/setting/stripe') }}" method="POST" class="pt-0">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-category-title"><strong>Payment Razer
                                                Key</strong></label>
                                        ...
                                        <small class="text-muted"><i class="fa fa-question-circle"></i>
                                            Enter your RAZER CLIENT ID
                                        </small>
                                    </div>
                                    <br>
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-category-title"><strong>Razer
                                                Secret</strong></label>
                                        <input type="password" class="form-control" id="ecommerce-category-title"
