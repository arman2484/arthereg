...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Shipping /</span> Add Shipping
    </h4>

    <form action="{{ url('app/ecommerce/shipping/add') }}" method="POST" class="pt-0"enctype="multipart/form-data">
        @csrf
