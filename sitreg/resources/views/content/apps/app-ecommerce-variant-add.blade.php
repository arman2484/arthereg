...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Variant /</span> Add Variant
    </h4>

    <form action="{{ url('app/ecommerce/variant/add') }}" method="POST" class="pt-0"enctype="multipart/form-data">
        @csrf
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Add your variants</h4>
